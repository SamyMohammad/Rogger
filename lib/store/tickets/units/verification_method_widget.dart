...
class VerificationMethodWidget extends StatelessWidget {
  ...
  final bool isVerificationContainer;
  ...
  const VerificationMethodWidget({
    ...
    required this.isVerificationContainer,
    this.isGuranteed,
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: (isAnyMethodVerified == true &&
                  isVerificationContainer &&
                  isGuranteed == false) ||
              (!isActivated && !isVerificationContainer)
          ? onTap
          : null,
      // isActivated
      //     ? null
      //     : isAnyMethodVerified == false
      //         ? null
      //         : isGuranteed == true
      //             ? null
      //             : onTap,
      //  || isGuranteed == false || isAnyMethodVerified==true ? onTap : null,
      child: Container(
          ...
          children: [
            Column(
              ...
              children: [
                ...
                Text(
                  isActivated || isGuranteed == true ? "مفعل" : "تفعيل",
                  style: TextStyle(
                      fontSize: 16,
            ...
            Padding(
              ...
              child: Align(
                ...
                child: isVerificationContainer == true
                    ? Image.asset(
                        height: 30,
                        width: 30,
